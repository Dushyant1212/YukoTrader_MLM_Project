...
Route::middleware('admin')->group(function () {
    ...
    Route::controller('ManageUsersController')->name('users.')->prefix('users')->group(function () {
        ...
        Route::get('referral/commissions/{id}', 'referralCommission')->name('referral.commission');
        Route::get('level/commissions/{id}', 'levelCommission')->name('level.commission');
    ...
    Route::controller('ReportController')->prefix('report')->name('report.')->group(function () {
        ...
        //Recharge
        Route::get('report/recharge', 'recharge')->name('recharge');

        //Commissions
        Route::get('report/commissions', 'commissions')->name('commissions');
        Route::get('report/commissions/search', 'commissionsSearch')->name('commissions.search');
        Route::get('report/commissions/log', 'commissionSelect')->name('commissions.log');
