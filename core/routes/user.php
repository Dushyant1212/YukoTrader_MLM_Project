    ...
    Route::middleware(['check.status'])->group(function () {
        ...
        Route::middleware('registration.complete')->namespace('User')->group(function () {
            ...
            Route::controller('UserController')->group(function(){
                ...
                Route::post('/balance/transfer/receiver', 'balanceTransferUser')->name('balance.transfer.anotheruser');

                //Commissions
                Route::get('/referral/users', 'referralLog')->name('referral.log');
                Route::get('/referral/commissions/plan', 'referralCommission')->name('referral.commissions');
                Route::get('/level/commissions/plan', 'levelCommission')->name('level.commissions');
