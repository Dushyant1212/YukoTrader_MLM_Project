...
{ 
    ...
    public function detail($id)
    {
        ...
        return view('admin.users.detail', compact('pageTitle', 'user','totalDeposit','totalWithdrawals','totalTransaction', 'totalReferralCommission', 'totalLevelCommission', 'totalPinGenerate', 'totalUsedPin', 'countries'));
    }
