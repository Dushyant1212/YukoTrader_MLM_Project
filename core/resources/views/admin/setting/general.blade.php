                ...
                <div class="card-body">
                    <form action="" method="POST">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 col-sm-6">
                                <div class="form-group">
                                    <label>@lang('E-Pin Generate Charge')</label>
                                    <div class="input-group">
                                        <input type="text" id="epin_charge" class="form-control form-control-lg"
                                            value="{{ getAmount($general->epin_charge) }}" name="epin_charge"
                            ...
                            <div class="col-md-4 col-sm-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="text" id="balance_transfer_percent_charge"
                                            class="form-control form-control-lg"
                                            value="{{ getAmount($general->balance_transfer_percent_charge) }}"
                                            name="balance_transfer_percent_charge" aria-describedby="basic-addon2"
                                            required="">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        <input type="text" id="price" class="form-control form-control-lg"
                                            ...
                                            name="balance_transfer_fixed_charge" required>
