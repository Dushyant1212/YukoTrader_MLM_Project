                    ...
                    <div class="sidebar-submenu {{ menuActive('admin.pin*', 2) }} ">
                        <ul>
                            <li class="sidebar-menu-item {{ menuActive('admin.pin.index') }} ">
                                <a href="{{ route('admin.pin.index') }}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('All Pins')</span>
                                </a>
                            </li>

                            <li class="sidebar-menu-item {{ menuActive('admin.pin.user') }} ">
                                <a href="{{ route('admin.pin.user') }}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('User Pins')</span>
                                </a>
                            </li>

                            <li class="sidebar-menu-item {{ menuActive('admin.pin.generate') }} ">
                                <a href="{{ route('admin.pin.generate') }}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Admin Pins')</span>
                                </a>
                            </li>

                            <li class="sidebar-menu-item {{ menuActive('admin.pin.used') }} ">
                                <a href="{{ route('admin.pin.used') }}" class="nav-link">
                                    <i class="menu-icon las la-lock-open"></i>
                                    <span class="menu-title">@lang('Used Pins')</span>
                                </a>
                            </li>

                            <li class="sidebar-menu-item {{ menuActive('admin.pin.unused') }} ">
                                <a href="{{ route('admin.pin.unused') }}" class="nav-link">
                                    <i class="menu-icon las la-lock"></i>
                                    <span class="menu-title">@lang('Unused Pins')</span>
                                </a>
                            </li>
                        </ul>
                    </div>
                ...
                <li class="sidebar-menu-item sidebar-dropdown">
                    ...
                    <div class="sidebar-submenu {{ menuActive('admin.report*', 2) }} ">
                        <ul>
                            ...
                            <li
                                class="sidebar-menu-item {{ menuActive(['admin.report.commissions', 'admin.report.commissions.search', 'admin.report.commissions.log']) }}">
                            ...
                            <li
                                class="sidebar-menu-item {{ menuActive(['admin.report.recharge', 'admin.report.recharge.search']) }}">
                                <a href="{{ route('admin.report.recharge') }}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Recharge Log')</span>
                                </a>
                            </li>
