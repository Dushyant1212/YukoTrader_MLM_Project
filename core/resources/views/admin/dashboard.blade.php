...
@section('panel')
    ...
    <div class="row gy-4 mt-2">
        ...
        <div class="col-xxl-3 col-sm-6">
            <div class="widget-two box--shadow2 b-radius--5 bg--white">
                ...
                <a href="{{route('admin.withdraw.pending')}}" class="widget-two__btn border border--warning btn-outline--warning">@lang('View All')</a>
            </div>
        </div>
        <div class="col-xxl-3 col-sm-6">
            <div class="widget-two box--shadow2 b-radius--5 bg--white">
                ...
                <a href="{{route('admin.withdraw.rejected')}}" class="widget-two__btn border border--danger btn-outline--danger">@lang('View All')</a>
            </div>
        </div>
        <div class="col-xxl-3 col-sm-6">
            <div class="widget-two box--shadow2 b-radius--5 bg--white">
                ...
                <a href="{{route('admin.withdraw.log')}}" class="widget-two__btn border border--primary btn-outline--primary">@lang('View All')</a>
            </div>
        </div>
    </div><!-- row end-->
    ...
    <div class="row gy-4 mt-2">
        <div class="col-xxl-3 col-sm-6">
            <div class="card bg--primary has-link overflow-hidden box--shadow2">
                <a href="{{route('admin.plan.index')}}" class="item-link"></a>
                <div class="card-body">
                    <div class="row align-items-center">
                    <div class="col-4">
                    ...
                    <div class="col-8 text-end">
                        <span class="text-white text--small">@lang('Total Plans')</span>
                        <h2 class="text-white">{{$widget['total_plans']}}</h2>
                    </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col-xxl-3 col-sm-6">
            <div class="card bg--warning has-link box--shadow2">
                <a href="{{route('admin.pin.index')}}" class="item-link"></a>
                <div class="card-body">
                    <div class="row align-items-center">
                    <div class="col-4">
                    ...
                    <div class="col-8 text-end">
                        <span class="text-white text--small">@lang('All Pins')</span>
                        <h2 class="text-white">{{$widget['total_pins']}}</h2>
                    </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col-xxl-3 col-sm-6">
            <div class="card bg--info has-link box--shadow2">
                <a href="{{route('admin.report.commissions')}}" class="item-link"></a>
                <div class="card-body">
                    <div class="row align-items-center">
                    <div class="col-4">
                    ...
                    <div class="col-8 text-end">
                        <span class="text-white text--small">@lang('Total Commissions')</span>
                        <h2 class="text-white">{{ $general->cur_sym }}{{ showAmount($widget['total_commissions']) }}</h2>
                    </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col-xxl-3 col-sm-6">
            <div class="card bg--success has-link box--shadow2">
                ...
                <div class="card-body">
                    ...
                    <div class="col-8 text-end">
                        <span class="text-white text--small">@lang('Used Pins')</span>
                        <h2 class="text-white">{{$widget['total_used_pins']}}</h2>
                    </div>
                    </div>
                </div>
            </div>
