                ...
                @if (!auth()->user()->ts)
                    <div class="col-md-6">
                        <div class="card custom--card primary-bg">
                            ...
                            <div class="card-body">
                                <h6 class="mb-3 subtitle--bordered">
                                    @lang('Use the QR code or setup key on your Google Authenticator app to add your account. ')
                                </h6>

                                <div class="contact-form-group mx-auto text-center">
                                ...
                                <div class="contact-form-group contact-form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <button type="button" class="input-group-text copytext bg--base border--base text-white" id="copyBoard"> <i
