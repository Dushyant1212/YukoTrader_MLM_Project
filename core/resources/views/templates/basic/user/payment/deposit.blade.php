                            ...
                            <div class="card-body">
                                <div class="contact-form-group contact-form-group">
                                    ...
                                    <div class="select-item">
                                        <select class="select-bar" name="gateway" required>
                                ...
                                <div class="mt-3 preview-details d-none">
                                    <ul class="list-group">
                                        ...
                                        <li class="list-group-item justify-content-between d-none rate-element primary-bg text--white">

                                        </li>
                                        <li class="list-group-item justify-content-between d-none in-site-cur primary-bg text--white">
                                            <span>@lang('In') <span class="method_currency"></span></span>
                                            <span class="final_amo fw-bold">0</span>
                                        </li>
                                        <li class="list-group-item justify-content-center crypto_currency d-none primary-bg text--white">
